    ...
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        ...
        <div class="row" style="gap: 8px;">
          ...
          >
            ${params.configSaving ? t("action.saving") : t("action.save")}
          </button>
        </div>
      </div>
      ...
      ${
        hasAgentAllow
          ? html`
              <div class="callout info" style="margin-top: 12px">
                ${t("agents.tools.explicitAllowlist")}
              </div>
            `
          : nothing
      }
  ...
  return html`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        ...
        <div class="row" style="gap: 8px;">
          ...
          <button class="btn btn--sm" ?disabled=${params.loading} @click=${params.onRefresh}>
            ${params.loading ? t("action.loading") : t("action.refresh")}
          </button>
          <button
            class="btn btn--sm primary"
            ?disabled=${params.configSaving || !params.configDirty}
      ...
      <div class="filters" style="margin-top: 14px;">
        ...
        <div class="muted">${t("skills.shown", filtered.length)}</div>
      </div>

      ${
        filtered.length === 0
          ? html`
              <div class="muted" style="margin-top: 16px">${t("skills.none")}</div>
            `
          : html`
