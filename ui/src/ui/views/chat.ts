    ...
    if (elapsed < COMPACTION_TOAST_DURATION_MS) {
      return html`
        <div class="compaction-indicator compaction-indicator--complete" role="status" aria-live="polite">
          ${icons.check} ${t("chat.compaction.done")}
        </div>
      `;
    }
  }
...
export function renderChat(props: ChatProps) {
  ...
  const composePlaceholder = props.connected
    ? hasAttachments
      ? t("chat.compose.placeholder.images")
      : t("chat.compose.placeholder")
    : t("chat.compose.placeholder.offline");
      ...
      ${
        props.showNewMessages
          ? html`
            ...
            >
              ${t("chat.new.messages")} ${icons.arrowDown}
            </button>
          `
          : nothing
      }
      ...
      <div class="chat-compose">
        ...
        <div class="chat-compose__row">
          <label class="field chat-compose__field">
            <span>${t("chat.compose.label")}</span>
            <textarea
          ...
          <div class="chat-compose__actions">
            ...
            >
              ${canAbort ? t("chat.stop") : t("chat.new.session")}
            </button>
            <button
              class="btn primary"
              ?disabled=${!props.connected}
